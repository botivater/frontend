...
const TenantSwitcherPage: NextPage = () => {
  ...
  const {
    error: allGuildsError,
    data: allGuildsData,
    isLoading: isAllGuildsLoading,
  } = useAllDiscordGuilds()
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4">
            <div>
              ...
              <p className="text-white text-opacity-30">
                Switch between Discord guilds.
              </p>
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
              <div>
                <label htmlFor="guildId" className="block font-bold">
                  Guild name:
                </label>
                <select
                  name="guildId"
                ...
                <small className="block">
                  Please choose the guild you want to work in here.
                </small>
              </div>
            </div>
          </div>
