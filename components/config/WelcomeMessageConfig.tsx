    ...
    return (
        <>
            <div>
                ...
                <select name="channelSnowflake" id="channelSnowflake" className='w-full bg-black bg-opacity-30 rounded border-none' value={welcomeMessageConfig.channelSnowflake} onChange={(e) => { setChannelSnowflake(e.target.value) }}>
            ...
            <div className="col-span-full">
                ...
                <div className="w-full bg-black bg-opacity-30 rounded border-none p-2">
                    <Slate
                        editor={editor}
                        value={initialValue}
                        onChange={
